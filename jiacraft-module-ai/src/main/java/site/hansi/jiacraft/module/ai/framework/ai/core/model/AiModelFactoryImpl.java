package site.hansi.jiacraft.module.ai.framework.ai.core.model;
...
import site.hansi.jiacraft.framework.common.util.spring.SpringUtils;
import site.hansi.jiacraft.module.ai.enums.model.AiPlatformEnum;
import site.hansi.jiacraft.module.ai.framework.ai.config.AiAutoConfiguration;
import site.hansi.jiacraft.module.ai.framework.ai.config.JiacraftAiProperties;
...
import site.hansi.jiacraft.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import site.hansi.jiacraft.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String apiKey, String url) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            JiacraftAiProperties.Midjourney properties = SpringUtil.getBean(JiacraftAiProperties.class)
                    .getMidjourney();
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#douBaoChatClient(JiacraftAiProperties)}
     */
    private ChatModel buildDouBaoChatModel(String apiKey) {
        JiacraftAiProperties.DouBao properties = new JiacraftAiProperties.DouBao()
                .setApiKey(apiKey);
        return new AiAutoConfiguration().buildDouBaoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#hunYuanChatClient(JiacraftAiProperties)}
     */
    private ChatModel buildHunYuanChatModel(String apiKey, String url) {
        JiacraftAiProperties.HunYuan properties = new JiacraftAiProperties.HunYuan()
                .setBaseUrl(url).setApiKey(apiKey);
        return new AiAutoConfiguration().buildHunYuanChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#siliconFlowChatClient(JiacraftAiProperties)}
     */
    private ChatModel buildSiliconFlowChatModel(String apiKey) {
        JiacraftAiProperties.SiliconFlow properties = new JiacraftAiProperties.SiliconFlow()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#xingHuoChatClient(JiacraftAiProperties)}
     */
    private static XingHuoChatModel buildXingHuoChatModel(String key) {
        ...
        JiacraftAiProperties.XingHuo properties = new JiacraftAiProperties.XingHuo()
                .setAppKey(keys.get(0)).setSecretKey(keys.get(1));
        return new AiAutoConfiguration().buildXingHuoChatClient(properties);
    }

    /**
     * 可参考 {@link AiAutoConfiguration#baiChuanChatClient(JiacraftAiProperties)}
     */
    private BaiChuanChatModel buildBaiChuanChatModel(String apiKey) {
        JiacraftAiProperties.BaiChuan properties = new JiacraftAiProperties.BaiChuan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(JiacraftAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        JiacraftAiProperties.Gemini properties = SpringUtil.getBean(JiacraftAiProperties.class)
