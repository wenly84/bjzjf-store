...
import site.hansi.jiacraft.framework.tenant.core.util.TenantUtils;
import site.hansi.jiacraft.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import site.hansi.jiacraft.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import site.hansi.jiacraft.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import site.hansi.jiacraft.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import site.hansi.jiacraft.module.ai.dal.dataobject.chat.AiChatConversationDO;
import site.hansi.jiacraft.module.ai.dal.dataobject.chat.AiChatMessageDO;
import site.hansi.jiacraft.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import site.hansi.jiacraft.module.ai.dal.dataobject.model.AiChatRoleDO;
import site.hansi.jiacraft.module.ai.dal.dataobject.model.AiModelDO;
import site.hansi.jiacraft.module.ai.dal.dataobject.model.AiToolDO;
import site.hansi.jiacraft.module.ai.dal.mysql.chat.AiChatMessageMapper;
import site.hansi.jiacraft.module.ai.enums.ErrorCodeConstants;
...
import site.hansi.jiacraft.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import site.hansi.jiacraft.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import site.hansi.jiacraft.module.ai.service.knowledge.AiKnowledgeDocumentService;
import site.hansi.jiacraft.module.ai.service.knowledge.AiKnowledgeSegmentService;
import site.hansi.jiacraft.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import site.hansi.jiacraft.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import site.hansi.jiacraft.module.ai.service.model.AiChatRoleService;
import site.hansi.jiacraft.module.ai.service.model.AiModelService;
import site.hansi.jiacraft.module.ai.service.model.AiToolService;
import site.hansi.jiacraft.module.ai.util.AiUtils;
import site.hansi.jiacraft.module.ai.util.FileTypeUtils;
...
import static site.hansi.jiacraft.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 jiacraft.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 jiacraft.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
