package site.hansi.jiacraft.module.ai.dal.dataobject.model;

import site.hansi.jiacraft.framework.mybatis.core.dataobject.BaseDO;
import site.hansi.jiacraft.module.ai.tool.function.DirectoryListToolFunction;
import site.hansi.jiacraft.module.ai.tool.function.WeatherQueryToolFunction;
...
public class AiToolDO extends BaseDO {
     ...
     * 状态
     *
     * 枚举 {@link site.hansi.jiacraft.framework.common.enums.CommonStatusEnum}
     */
