package site.hansi.jiacraft.module.infra.service.logger;
...
import site.hansi.jiacraft.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import site.hansi.jiacraft.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import site.hansi.jiacraft.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import site.hansi.jiacraft.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static site.hansi.jiacraft.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static site.hansi.jiacraft.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        ApiErrorLogDO apiErrorLogDO = randomPojo(ApiErrorLogDO.class, o -> {
            ...
            o.setApplicationName("jiacraft-test");
            o.setRequestUrl("foo");
        ...
        reqVO.setApplicationName("jiacraft-test");
