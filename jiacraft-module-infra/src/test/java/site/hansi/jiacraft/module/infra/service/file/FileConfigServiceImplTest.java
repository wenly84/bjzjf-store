package site.hansi.jiacraft.module.infra.service.file;
...
import site.hansi.jiacraft.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import site.hansi.jiacraft.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import site.hansi.jiacraft.module.infra.dal.dataobject.file.FileConfigDO;
import site.hansi.jiacraft.module.infra.dal.mysql.file.FileConfigMapper;
import site.hansi.jiacraft.module.infra.framework.file.core.client.FileClient;
import site.hansi.jiacraft.module.infra.framework.file.core.client.FileClientConfig;
import site.hansi.jiacraft.module.infra.framework.file.core.client.FileClientFactory;
import site.hansi.jiacraft.module.infra.framework.file.core.client.local.LocalFileClient;
import site.hansi.jiacraft.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import site.hansi.jiacraft.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static site.hansi.jiacraft.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static site.hansi.jiacraft.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("北京智匠坊")
