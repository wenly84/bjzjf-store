package site.hansi.jiacraft.module.infra.controller.admin.logger.vo.apiaccesslog;
...
public class ApiAccessLogRespVO {
    ...
    @DictFormat(site.hansi.jiacraft.module.infra.enums.DictTypeConstants.OPERATE_TYPE)
    ...
    @Schema(description = "结果提示", example = "北京智匠坊，牛逼！")
    @ExcelProperty("结果提示")
