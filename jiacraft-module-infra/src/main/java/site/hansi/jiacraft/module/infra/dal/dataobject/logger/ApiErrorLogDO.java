package site.hansi.jiacraft.module.infra.dal.dataobject.logger;
...
public class ApiErrorLogDO extends BaseDO {
     ...
     * 处理用户编号
     *
     * 关联 site.hansi.jiacraft.adminserver.modules.system.dal.dataobject.user.SysUserDO.SysUserDO#getId()
     */
