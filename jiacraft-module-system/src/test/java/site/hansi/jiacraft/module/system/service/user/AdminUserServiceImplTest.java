package site.hansi.jiacraft.module.system.service.user;

import cn.hutool.core.util.RandomUtil;
import site.hansi.jiacraft.framework.common.enums.CommonStatusEnum;
import site.hansi.jiacraft.framework.common.exception.ServiceException;
...
import site.hansi.jiacraft.framework.test.core.ut.BaseDbUnitTest;
import site.hansi.jiacraft.module.infra.api.config.ConfigApi;
import site.hansi.jiacraft.module.infra.api.file.FileApi;
import site.hansi.jiacraft.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import site.hansi.jiacraft.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import site.hansi.jiacraft.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import site.hansi.jiacraft.module.system.controller.admin.user.vo.user.UserImportRespVO;
import site.hansi.jiacraft.module.system.controller.admin.user.vo.user.UserPageReqVO;
import site.hansi.jiacraft.module.system.controller.admin.user.vo.user.UserSaveReqVO;
...
import site.hansi.jiacraft.module.system.dal.dataobject.dept.UserPostDO;
import site.hansi.jiacraft.module.system.dal.dataobject.tenant.TenantDO;
import site.hansi.jiacraft.module.system.dal.dataobject.user.AdminUserDO;
import site.hansi.jiacraft.module.system.dal.mysql.dept.UserPostMapper;
import site.hansi.jiacraft.module.system.dal.mysql.user.AdminUserMapper;
import site.hansi.jiacraft.module.system.enums.common.SexEnum;
import site.hansi.jiacraft.module.system.service.dept.DeptService;
import site.hansi.jiacraft.module.system.service.dept.PostService;
import site.hansi.jiacraft.module.system.service.permission.PermissionService;
import site.hansi.jiacraft.module.system.service.tenant.TenantService;
...
import static site.hansi.jiacraft.framework.common.util.collection.SetUtils.asSet;
import static site.hansi.jiacraft.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static site.hansi.jiacraft.framework.common.util.date.LocalDateTimeUtils.buildTime;
import static site.hansi.jiacraft.framework.common.util.object.ObjectUtils.cloneIgnoreId;
import static site.hansi.jiacraft.framework.test.core.util.AssertUtils.assertPojoEquals;
import static site.hansi.jiacraft.framework.test.core.util.AssertUtils.assertServiceException;
import static site.hansi.jiacraft.framework.test.core.util.RandomUtils.*;
import static site.hansi.jiacraft.module.system.enums.ErrorCodeConstants.*;
import static site.hansi.jiacraft.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("jiacraftyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("jiacraftyuanma");
        ...
        assertEquals("jiacraftyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("jiacraftyuanma"))).thenReturn("java");
