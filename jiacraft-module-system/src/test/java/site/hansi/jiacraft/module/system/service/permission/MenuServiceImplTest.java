package site.hansi.jiacraft.module.system.service.permission;
...
import site.hansi.jiacraft.module.system.controller.admin.permission.vo.menu.MenuListReqVO;
import site.hansi.jiacraft.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import site.hansi.jiacraft.module.system.dal.dataobject.permission.MenuDO;
import site.hansi.jiacraft.module.system.dal.mysql.permission.MenuMapper;
import site.hansi.jiacraft.module.system.enums.permission.MenuTypeEnum;
...
import static site.hansi.jiacraft.module.system.dal.dataobject.permission.MenuDO.ID_ROOT;
...
public class MenuServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetMenuList() {
        // mock 数据
        MenuDO menuDO = randomPojo(MenuDO.class, o -> o.setName("智匠坊").setStatus(CommonStatusEnum.ENABLE.getStatus()));
        menuMapper.insert(menuDO);
        // 测试 status 不匹配
