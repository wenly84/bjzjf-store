...
import site.hansi.jiacraft.framework.common.util.cache.CacheUtils;
import site.hansi.jiacraft.framework.common.util.http.HttpUtils;
import site.hansi.jiacraft.framework.common.util.object.BeanUtils;
import site.hansi.jiacraft.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import site.hansi.jiacraft.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import site.hansi.jiacraft.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import site.hansi.jiacraft.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import site.hansi.jiacraft.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import site.hansi.jiacraft.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import site.hansi.jiacraft.module.system.dal.dataobject.social.SocialClientDO;
import site.hansi.jiacraft.module.system.dal.mysql.social.SocialClientMapper;
import site.hansi.jiacraft.module.system.dal.redis.RedisKeyConstants;
import site.hansi.jiacraft.module.system.enums.social.SocialTypeEnum;
import site.hansi.jiacraft.module.system.framework.justauth.core.AuthRequestFactory;
...
import static site.hansi.jiacraft.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static site.hansi.jiacraft.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${jiacraft.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${jiacraft.wxa-subscribe-message.miniprogram-state:formal}")
