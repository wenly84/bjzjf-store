package site.hansi.jiacraft.module.system.controller.admin.sms.vo.channel;
...
public class SmsChannelSaveReqVO {
    ...
    @Schema(description = "短信签名", requiredMode = Schema.RequiredMode.REQUIRED, example = "北京智匠坊")
    ...
    @Schema(description = "短信 API 的账号", requiredMode = Schema.RequiredMode.REQUIRED, example = "jiacraft")
