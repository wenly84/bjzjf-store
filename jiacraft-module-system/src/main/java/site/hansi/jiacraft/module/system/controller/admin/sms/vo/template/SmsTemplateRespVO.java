package site.hansi.jiacraft.module.system.controller.admin.sms.vo.template;
...
public class SmsTemplateRespVO {
    ...
    @Schema(description = "模板名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "jiacraft")
    @ExcelProperty("模板名称")
    private String name;
