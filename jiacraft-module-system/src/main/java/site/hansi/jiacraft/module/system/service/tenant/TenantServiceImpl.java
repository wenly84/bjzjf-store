...
import site.hansi.jiacraft.module.system.controller.admin.permission.vo.role.RoleSaveReqVO;
...
import site.hansi.jiacraft.module.system.convert.tenant.TenantConvert;
...
public class TenantServiceImpl implements TenantService {
    ...
    @Autowired(required = false) // 由于 jiacraft.tenant.enable 配置项，可以关闭多租户的功能，所以这里只能不强制注入
