package site.hansi.jiacraft.module.pay.convert.order;
...
public interface PayOrderConvert {
    ...
    PayOrderSubmitRespVO convert(PayOrderDO order, site.hansi.jiacraft.module.pay.framework.pay.core.client.dto.order.PayOrderRespDTO respDTO);
