...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "site.hansi";
    private static final String ARTIFACT_ID = "jiacraft";
    private static final String PACKAGE_NAME = "site.hansi.jiacraft";
    private static final String TITLE = "智匠坊运营支撑系统";
    ...
    public static void main(String[] args) {
        ...
        String projectBaseDir = "D:\\workspace_java\\bjzjf-store";
        log.info("[main][原项目路劲改地址 ({})]", projectBaseDir);

        // ========== 配置，需要你手动修改 ==========
        String groupIdNew = "site.hansi";
        String artifactIdNew = "jiacraft";
        String packageNameNew = "site.hansi.jiacraft";
        String titleNew = "智匠坊运营支撑系统";
