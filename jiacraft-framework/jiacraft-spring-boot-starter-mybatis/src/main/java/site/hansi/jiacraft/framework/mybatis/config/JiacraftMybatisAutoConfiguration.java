package site.hansi.jiacraft.framework.mybatis.config;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.core.util.StrUtil;
import site.hansi.jiacraft.framework.common.util.json.JsonUtils;
import site.hansi.jiacraft.framework.mybatis.core.handler.DefaultDBFieldHandler;
...
@MapperScan(value = "${jiacraft.info.base-package}", annotationClass = Mapper.class,
        lazyInitialization = "${mybatis.lazy-initialization:false}") // Mapper 懒加载，目前仅用于单元测试
public class JiacraftMybatisAutoConfiguration {
