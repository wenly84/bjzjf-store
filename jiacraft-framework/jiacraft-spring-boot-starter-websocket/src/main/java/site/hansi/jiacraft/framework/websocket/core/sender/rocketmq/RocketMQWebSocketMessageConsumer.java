package site.hansi.jiacraft.framework.websocket.core.sender.rocketmq;
...
@RocketMQMessageListener( // 重点：添加 @RocketMQMessageListener 注解，声明消费的 topic
        topic = "${jiacraft.websocket.sender-rocketmq.topic}",
        consumerGroup = "${jiacraft.websocket.sender-rocketmq.consumer-group}",
