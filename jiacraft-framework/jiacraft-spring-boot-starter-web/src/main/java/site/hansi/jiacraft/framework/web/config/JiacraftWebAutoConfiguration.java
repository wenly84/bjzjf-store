package site.hansi.jiacraft.framework.web.config;
...
import site.hansi.jiacraft.framework.web.core.filter.CacheRequestBodyFilter;
import site.hansi.jiacraft.framework.web.core.filter.DemoFilter;
import site.hansi.jiacraft.framework.web.core.handler.GlobalExceptionHandler;
import site.hansi.jiacraft.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class JiacraftWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "jiacraft.demo", havingValue = "true")
