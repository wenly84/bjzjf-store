package site.hansi.jiacraft.framework.jackson.config;

import site.hansi.jiacraft.framework.common.util.json.JsonUtils;
import site.hansi.jiacraft.framework.common.util.json.databind.NumberSerializer;
import site.hansi.jiacraft.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import site.hansi.jiacraft.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class JiacraftJacksonAutoConfiguration {
