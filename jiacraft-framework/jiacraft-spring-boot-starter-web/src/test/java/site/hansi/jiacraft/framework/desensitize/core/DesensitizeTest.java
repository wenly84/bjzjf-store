package site.hansi.jiacraft.framework.desensitize.core;

import site.hansi.jiacraft.framework.common.util.json.JsonUtils;
import site.hansi.jiacraft.framework.desensitize.core.annotation.Address;
import site.hansi.jiacraft.framework.desensitize.core.regex.annotation.EmailDesensitize;
import site.hansi.jiacraft.framework.desensitize.core.regex.annotation.RegexDesensitize;
import site.hansi.jiacraft.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("北京智匠坊");
        ...
        desensitizeDemo.setRegex("你好，我是北京智匠坊");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("北京智匠坊");
        ...
        assertEquals("北京智匠坊", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "北京智匠坊", replacer = "*")
