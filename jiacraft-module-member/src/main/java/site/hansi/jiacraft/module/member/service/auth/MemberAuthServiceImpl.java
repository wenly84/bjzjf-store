...
import site.hansi.jiacraft.framework.common.enums.TerminalEnum;
...
import site.hansi.jiacraft.module.member.convert.auth.AuthConvert;
...
import site.hansi.jiacraft.framework.common.biz.system.oauth2.dto.OAuth2AccessTokenCreateReqDTO;
...
import site.hansi.jiacraft.module.system.api.social.dto.SocialWxPhoneNumberInfoRespDTO;
...
import static site.hansi.jiacraft.module.member.enums.ErrorCodeConstants.*;
...
public class MemberAuthServiceImpl implements MemberAuthService {
    ...
    public void sendSmsCode(Long userId, AppAuthSmsSendReqVO reqVO) {
        ...
        if (Objects.equals(reqVO.getScene(), SmsSceneEnum.MEMBER_UPDATE_PASSWORD.getScene())) {
            ...
            // TODO 智匠坊：后续 member user 手机非强绑定，这块需要做下调整；
