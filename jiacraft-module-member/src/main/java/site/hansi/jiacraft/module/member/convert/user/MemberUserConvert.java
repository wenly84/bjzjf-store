package site.hansi.jiacraft.module.member.convert.user;

import site.hansi.jiacraft.framework.common.pojo.PageResult;
import site.hansi.jiacraft.module.member.api.user.dto.MemberUserRespDTO;
import site.hansi.jiacraft.module.member.controller.admin.user.vo.MemberUserRespVO;
import site.hansi.jiacraft.module.member.controller.admin.user.vo.MemberUserUpdateReqVO;
import site.hansi.jiacraft.module.member.controller.app.user.vo.AppMemberUserInfoRespVO;
