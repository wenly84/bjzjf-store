...
import site.hansi.jiacraft.module.member.controller.app.user.vo.AppMemberUserUpdateMobileReqVO;
...
import site.hansi.jiacraft.module.member.service.auth.MemberAuthServiceImpl;
 ...
 */
@Disabled
@Import({MemberUserServiceImpl.class, JiacraftRedisAutoConfiguration.class})
