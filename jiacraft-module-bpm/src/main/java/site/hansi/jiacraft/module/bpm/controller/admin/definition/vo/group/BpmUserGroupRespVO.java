package site.hansi.jiacraft.module.bpm.controller.admin.definition.vo.group;
...
public class BpmUserGroupRespVO {
    ...
    @Schema(description = "描述", requiredMode = Schema.RequiredMode.REQUIRED, example = "北京智匠坊")
