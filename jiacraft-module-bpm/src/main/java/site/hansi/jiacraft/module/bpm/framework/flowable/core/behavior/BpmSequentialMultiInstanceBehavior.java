package site.hansi.jiacraft.module.bpm.framework.flowable.core.behavior;

import cn.hutool.core.collection.CollUtil;
import site.hansi.jiacraft.framework.common.util.collection.SetUtils;
import site.hansi.jiacraft.module.bpm.enums.definition.BpmChildProcessMultiInstanceSourceTypeEnum;
...
public class BpmSequentialMultiInstanceBehavior extends SequentialMultiInstanceBehavior {
    ...
    protected void executeOriginalBehavior(DelegateExecution execution, ExecutionEntity multiInstanceRootExecution, int loopCounter) {
        ...
        // 参见 https://gitee.com/zhijiantianya/jiacraft-cloud/issues/IC239F
