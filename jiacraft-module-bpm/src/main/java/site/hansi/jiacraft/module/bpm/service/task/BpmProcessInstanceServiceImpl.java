package site.hansi.jiacraft.module.bpm.service.task;
...
import site.hansi.jiacraft.framework.common.util.object.PageUtils;
import site.hansi.jiacraft.module.bpm.api.task.dto.BpmProcessInstanceCreateReqDTO;
import site.hansi.jiacraft.module.bpm.controller.admin.definition.vo.model.BpmModelMetaInfoVO;
import site.hansi.jiacraft.module.bpm.controller.admin.definition.vo.model.simple.BpmSimpleModelNodeVO;
import site.hansi.jiacraft.module.bpm.controller.admin.task.vo.instance.*;
import site.hansi.jiacraft.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNodeTask;
import site.hansi.jiacraft.module.bpm.controller.admin.task.vo.task.BpmTaskRespVO;
import site.hansi.jiacraft.module.bpm.convert.task.BpmProcessInstanceConvert;
import site.hansi.jiacraft.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import site.hansi.jiacraft.module.bpm.dal.redis.BpmProcessIdRedisDAO;
import site.hansi.jiacraft.module.bpm.enums.ErrorCodeConstants;
import site.hansi.jiacraft.module.bpm.enums.definition.BpmModelTypeEnum;
import site.hansi.jiacraft.module.bpm.enums.definition.BpmSimpleModelNodeTypeEnum;
import site.hansi.jiacraft.module.bpm.enums.task.BpmProcessInstanceStatusEnum;
import site.hansi.jiacraft.module.bpm.enums.task.BpmReasonEnum;
import site.hansi.jiacraft.module.bpm.enums.task.BpmTaskStatusEnum;
import site.hansi.jiacraft.module.bpm.framework.flowable.core.candidate.BpmTaskCandidateInvoker;
import site.hansi.jiacraft.module.bpm.framework.flowable.core.enums.BpmTaskCandidateStrategyEnum;
import site.hansi.jiacraft.module.bpm.framework.flowable.core.enums.BpmnModelConstants;
import site.hansi.jiacraft.module.bpm.framework.flowable.core.enums.BpmnVariableConstants;
import site.hansi.jiacraft.module.bpm.framework.flowable.core.event.BpmProcessInstanceEventPublisher;
import site.hansi.jiacraft.module.bpm.framework.flowable.core.util.BpmHttpRequestUtils;
import site.hansi.jiacraft.module.bpm.framework.flowable.core.util.BpmnModelUtils;
import site.hansi.jiacraft.module.bpm.framework.flowable.core.util.FlowableUtils;
import site.hansi.jiacraft.module.bpm.framework.flowable.core.util.SimpleModelUtils;
import site.hansi.jiacraft.module.bpm.service.definition.BpmProcessDefinitionService;
import site.hansi.jiacraft.module.bpm.service.message.BpmMessageService;
import site.hansi.jiacraft.module.system.api.dept.DeptApi;
import site.hansi.jiacraft.module.system.api.dept.dto.DeptRespDTO;
...
import static site.hansi.jiacraft.module.bpm.controller.admin.task.vo.instance.BpmApprovalDetailRespVO.ActivityNode;
import static site.hansi.jiacraft.module.bpm.enums.ErrorCodeConstants.*;
import static site.hansi.jiacraft.module.bpm.framework.flowable.core.enums.BpmnModelConstants.START_USER_NODE_ID;
import static site.hansi.jiacraft.module.bpm.framework.flowable.core.enums.BpmnVariableConstants.PROCESS_INSTANCE_VARIABLE_NEED_SIMULATE_PREFIX;
import static site.hansi.jiacraft.module.bpm.framework.flowable.core.util.BpmnModelUtils.parseNodeType;
