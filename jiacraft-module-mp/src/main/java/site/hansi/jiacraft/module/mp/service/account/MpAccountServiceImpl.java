package site.hansi.jiacraft.module.mp.service.account;
...
import site.hansi.jiacraft.module.mp.convert.account.MpAccountConvert;
import site.hansi.jiacraft.module.mp.dal.dataobject.account.MpAccountDO;
import site.hansi.jiacraft.module.mp.dal.mysql.account.MpAccountMapper;
import site.hansi.jiacraft.module.mp.enums.ErrorCodeConstants;
...
import static site.hansi.jiacraft.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 jiacraft-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
