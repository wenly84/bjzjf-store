package site.hansi.jiacraft.module.mp.service.message;
...
import site.hansi.jiacraft.module.mp.controller.admin.message.vo.autoreply.MpAutoReplyCreateReqVO;
import site.hansi.jiacraft.module.mp.controller.admin.message.vo.autoreply.MpAutoReplyUpdateReqVO;
import site.hansi.jiacraft.module.mp.controller.admin.message.vo.message.MpMessagePageReqVO;
import site.hansi.jiacraft.module.mp.convert.message.MpAutoReplyConvert;
import site.hansi.jiacraft.module.mp.dal.dataobject.account.MpAccountDO;
import site.hansi.jiacraft.module.mp.dal.dataobject.message.MpAutoReplyDO;
import site.hansi.jiacraft.module.mp.dal.mysql.message.MpAutoReplyMapper;
import site.hansi.jiacraft.module.mp.enums.message.MpAutoReplyTypeEnum;
import site.hansi.jiacraft.module.mp.framework.mp.core.util.MpUtils;
import site.hansi.jiacraft.module.mp.service.account.MpAccountService;
import site.hansi.jiacraft.module.mp.service.message.bo.MpMessageSendOutReqBO;
