package site.hansi.jiacraft.module.mp.controller.admin.account.vo;
...
public class MpAccountBaseVO {
    ...
    @Schema(description = "公众号名称", requiredMode = Schema.RequiredMode.REQUIRED, example = "北京智匠坊")
    @NotEmpty(message = "公众号名称不能为空")
    private String name;

    @Schema(description = "公众号微信号", requiredMode = Schema.RequiredMode.REQUIRED, example = "jiacraftyuanma")
    ...
    @Schema(description = "备注", example = "请关注北京智匠坊，学习技术")
