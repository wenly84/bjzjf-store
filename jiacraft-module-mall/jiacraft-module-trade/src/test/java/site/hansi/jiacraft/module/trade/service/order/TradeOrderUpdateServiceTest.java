...
import site.hansi.jiacraft.module.member.api.user.MemberUserApi;
...
import site.hansi.jiacraft.module.product.api.sku.ProductSkuApi;
import site.hansi.jiacraft.module.product.api.spu.ProductSpuApi;
import site.hansi.jiacraft.module.promotion.api.coupon.CouponApi;
import site.hansi.jiacraft.module.system.api.notify.NotifyMessageSendApi;
...
import site.hansi.jiacraft.module.trade.enums.order.TradeOrderRefundStatusEnum;
import site.hansi.jiacraft.module.trade.enums.order.TradeOrderStatusEnum;
import site.hansi.jiacraft.module.trade.framework.order.config.TradeOrderConfig;
import site.hansi.jiacraft.module.trade.framework.order.config.TradeOrderProperties;
import site.hansi.jiacraft.module.trade.service.cart.CartServiceImpl;
import site.hansi.jiacraft.module.trade.service.delivery.DeliveryExpressService;
import site.hansi.jiacraft.module.trade.service.delivery.DeliveryExpressServiceImpl;
import site.hansi.jiacraft.module.trade.service.message.TradeMessageServiceImpl;
import site.hansi.jiacraft.module.trade.service.order.handler.TradeOrderHandler;
import site.hansi.jiacraft.module.trade.service.price.TradePriceServiceImpl;
import site.hansi.jiacraft.module.trade.service.price.calculator.TradePriceCalculator;
...
//        // mock 方法（用户收件地址的校验）
//        MemberAddressRespDTO addressRespDTO = new MemberAddressRespDTO().setId(10L).setUserId(userId).setName("智匠坊")
...
//        assertEquals(tradeOrderDO.getReceiverName(), "智匠坊");
