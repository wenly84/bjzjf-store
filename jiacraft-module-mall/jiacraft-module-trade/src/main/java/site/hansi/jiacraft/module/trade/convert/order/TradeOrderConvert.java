...
import site.hansi.jiacraft.module.product.api.property.dto.ProductPropertyValueDetailRespDTO;
import site.hansi.jiacraft.module.product.api.sku.dto.ProductSkuRespDTO;
import site.hansi.jiacraft.module.product.api.sku.dto.ProductSkuUpdateStockReqDTO;
...
import site.hansi.jiacraft.module.trade.controller.admin.base.member.user.MemberUserRespVO;
import site.hansi.jiacraft.module.trade.controller.admin.base.product.property.ProductPropertyValueDetailRespVO;
import site.hansi.jiacraft.module.trade.controller.admin.order.vo.*;
import site.hansi.jiacraft.module.trade.controller.app.base.property.AppProductPropertyValueDetailRespVO;
import site.hansi.jiacraft.module.trade.controller.app.order.vo.*;
import site.hansi.jiacraft.module.trade.controller.app.order.vo.item.AppTradeOrderItemCommentCreateReqVO;
import site.hansi.jiacraft.module.trade.controller.app.order.vo.item.AppTradeOrderItemRespVO;
...
import site.hansi.jiacraft.module.trade.framework.delivery.core.client.dto.ExpressTrackRespDTO;
import site.hansi.jiacraft.module.trade.framework.order.config.TradeOrderProperties;
import site.hansi.jiacraft.module.trade.service.brokerage.bo.BrokerageAddReqBO;
...
import static site.hansi.jiacraft.framework.common.util.collection.CollectionUtils.convertMultiMap;
import static site.hansi.jiacraft.framework.common.util.date.LocalDateTimeUtils.addTime;
...
public interface TradeOrderConvert {
    ...
    default PayOrderCreateReqDTO convert(TradeOrderDO order, List<TradeOrderItemDO> orderItems,
        ...
        createReqDTO.setBody(subject); // TODO 智匠坊：临时写死
        // 订单相关字段
